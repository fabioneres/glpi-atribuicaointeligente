...
| Documento | Valor |
| --- | --- |
| Versao | 1.3.1 - dashboard de distribuicoes configuravel e escopo multi-entidade corrigido |
...
| Entidades | Habilitacao manual do plugin por entidade, reduzindo processamento e logs fora do escopo desejado. Entidades entram inativas por padrao em instalacoes novas e podem ser habilitadas/desabilitadas em lote pela tela de configuracao. |
